...
namespace Warspace
{
    ...
    {
        private static TimeSpan FIRE_RATE_AI = TimeSpan.FromMilliseconds(720); // Fire every X ms
        public const int MAX_LEVEL_BEFORE_RESTART = 30;
        public const int KILL_DISTANCE = 720;
        public const int DISTANCE_AWAY_FROM_BOUNDARY = 420;
        public const int ROTATION_BUFFER = 20;
        public const int TIME_TO_WAIT_AFTER_BOUNDARY_LEAVE = 1000;

        public TimeSpan GiveUpDuration = TimeSpan.FromSeconds(5);
