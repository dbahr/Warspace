...
namespace Warspace.Authentication
{
    public class WarspaceAuthenticationProvider : CookieAuthenticationProvider
    {
        ...
        public static void SetState(RegisteredClient rc, IOwinResponse response)
        {
            ...
            Byte[] encrypted = MachineKey.Protect(identity, "Warspace.Identity");
            ...
            response.Cookies.Append("Warspace.UserProfile", state, new CookieOptions
            {
