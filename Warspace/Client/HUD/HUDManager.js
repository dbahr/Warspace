...
(function (Warspace) {
    var HUDManager = (function () {
        function HUDManager(initialization, _shipManager, areaRenderer, keyboard, serverAdapter) {
            ...
            this._shipStatMonitor = new Warspace.ShipStatMonitor();
            this._shipHealthMonitor = new Warspace.HealthMonitor();
            this._shipExperienceMonitor = new Warspace.ExperienceMonitor();
            this._rankingsManager = new Warspace.RankingsManager();
            this._environmentMonitor = new Warspace.EnvironmentMonitor(areaRenderer, this._shipManager.UserShipManager);
            this._leaderboardManager = new Warspace.LeaderboardManager(this._myShipId, keyboard, serverAdapter);
            this._deathScreen = new Warspace.DeathScreen();
            this._notificationManager = new Warspace.NotificationManager(serverAdapter);
            this._userInformationManager = new Warspace.UserInformationManager(initialization.UserInformation);
            this._chat = new Warspace.Chat(initialization.UserInformation, serverAdapter);
    ...
    Warspace.HUDManager = HUDManager;
})(Warspace || (Warspace = {}));
