...
(function (Warspace) {
    var DeathScreen = (function () {
        function DeathScreen() {
            ...
            this._randomQuotes = [
                ...
                //["=(", ""]
                ["GUESS YOU NEED TO TALK TO BRETT FOR SA PRIVILEGES", ""],
                ["CONTACT 'IT' TO SETUP A SHIP REBOOT", ""],
                ["YEA, SURE, YOU CAN BLAME IT ON ZACH", ""],
                ["GUESS MY MACHINE IS FASTER", ""]
            ];
        }
    ...
    Warspace.DeathScreen = DeathScreen;
})(Warspace || (Warspace = {}));
