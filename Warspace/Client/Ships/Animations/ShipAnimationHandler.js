...
(function (Warspace) {
    var ShipAnimationHandler = (function () {
        function ShipAnimationHandler(_ship, _contentManager) {
            ...
            this._thrustAnimation = new Warspace.ShipThrustAnimation(this._contentManager);
            this._boostAnimation = new Warspace.ShipBoostAnimation(this._contentManager);
            this._deathAnimation = new Warspace.ShipDeathAnimation(this._contentManager);
    ...
    Warspace.ShipAnimationHandler = ShipAnimationHandler;
})(Warspace || (Warspace = {}));
