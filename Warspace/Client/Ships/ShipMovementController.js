...
(function (Warspace) {
    var ShipMovementController = (function (_super) {
        ...
        function ShipMovementController(movables) {
            ...
            this._interpolationManager = new Warspace.ShipInterpolationManager(this);
        ...
        ShipMovementController.ROTATE_SPEED = 300;
    ...
    Warspace.ShipMovementController = ShipMovementController;
})(Warspace || (Warspace = {}));
