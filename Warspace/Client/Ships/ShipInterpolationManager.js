...
(function (Warspace) {
    var ShipInterpolationManager = (function () {
        function ShipInterpolationManager(_movementController) {
            ...
            this._interpolationDuration = eg.TimeSpan.FromMilliseconds(Warspace.Game.GameConfiguration.gameConfig.DRAW_INTERVAL * 2);
    ...
    Warspace.ShipInterpolationManager = ShipInterpolationManager;
})(Warspace || (Warspace = {}));
