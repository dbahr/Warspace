...
(function (Warspace) {
    var Ship = (function (_super) {
        ...
        function Ship(payload, contentManager) {
            var lifeController = new Warspace.ShipLifeController(payload);
            var levelManager = new Warspace.ShipLevelManager(payload);
            var graphic = new Warspace.ShipGraphic(payload.Name, payload.UserControlled, payload.Style, levelManager, lifeController, payload.MovementController.Position, payload.MovementController.Rotation, Ship.SIZE, contentManager);
            ...
            this.MovementController = new Warspace.ShipMovementController(new Array(this.Bounds, this.Graphic));
            this.MovementController.UserControlled = payload.UserControlled;
            this.AbilityHandler = new Warspace.ShipAbilityHandler(this);
            this.AnimationHandler = new Warspace.ShipAnimationHandler(this, contentManager);
