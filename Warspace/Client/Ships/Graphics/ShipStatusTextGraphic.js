...
(function (Warspace) {
    var ShipStatusTextGraphic = (function (_super) {
        ...
        ShipStatusTextGraphic.prototype.Status = function (text, size, color, fadeDuration, reverseDirection) {
            var _this = this;
            var status = new Warspace.StatusText(text, size, color, fadeDuration, reverseDirection), id = this._statusIds++;
    ...
    Warspace.ShipStatusTextGraphic = ShipStatusTextGraphic;
})(Warspace || (Warspace = {}));
