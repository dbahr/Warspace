...
(function (Warspace) {
    var ShipLifeGraphic = (function (_super) {
        ...
        function ShipLifeGraphic(lifeController) {
            var _this = this;
            var width = Warspace.Ship.SIZE.Width * ShipLifeGraphic.SHIP_WIDTH_PARTIAL;
            _super.call(this, 0, Warspace.Ship.SIZE.HalfHeight + ShipLifeGraphic.Y_OFFSET, width, ShipLifeGraphic.HEIGHT, ShipLifeGraphic.BACKGROUND_COLOR);
        ...
        ShipLifeGraphic.prototype.OverlayColor = function () {
            ...
            if (healthPercentage <= Warspace.ShipLifeController.BAD_THRESHOLD) {
                return Warspace.ShipLifeController.BAD_COLOR;
            }
            else if (healthPercentage <= Warspace.ShipLifeController.HURT_THRESHOLD) {
                return Warspace.ShipLifeController.HURT_COLOR;
            }
            else {
                return Warspace.ShipLifeController.GOOD_COLOR;
            }
        };
    ...
    Warspace.ShipLifeGraphic = ShipLifeGraphic;
})(Warspace || (Warspace = {}));
