...
module Warspace {
    ...
    export class ShipGraphic extends eg.Graphics.Rectangle {
        ...
        constructor(name: string, userControlled: boolean, style: number, levelManager: ShipLevelManager, lifeController: ShipLifeController, position: eg.Vector2d, rotation: number, size: eg.Size2d, contentManager: eg.Content.ContentManager) {
            ...
            this.Body = new ShipBodyGraphic(style);
