...
(function (Warspace) {
        ...
        AreaRenderer.prototype.BuildSectors = function () {
            ...
            for (var i = 0; i < gridCount; i++) {
                for (var j = 0; j < gridCount; j++) {
                    area = new Warspace.Area(locationOffset + this._areaSize.Width * j, locationOffset + this._areaSize.Width * i, this._areaSize.Width, AreaRenderer.AREA_LETTERS[j] + (i + 1));
                    area.ZIndex = -1;
    ...
    Warspace.AreaRenderer = AreaRenderer;
})(Warspace || (Warspace = {}));
