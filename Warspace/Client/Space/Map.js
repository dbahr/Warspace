    ...
    var Map = (function () {
        ...
        Map.prototype.BuildBoundaries = function () {
            ...
            for (var i = 0; i < corners.length; i++) {
                boundary = new Warspace.MapBoundary(new eg.Vector2d(corners[i].X, corners[i].Y), new eg.Vector2d(corners[(i + 1) % corners.length].X, corners[(i + 1) % corners.length].Y));
        ...
        Map.prototype.BuildAreas = function () {
            this.AreaRenderer = new Warspace.AreaRenderer(this._scene, this._keyboard);
