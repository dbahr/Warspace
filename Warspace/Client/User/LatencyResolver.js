...
(function (Warspace) {
    var LatencyResolver = (function () {
        ...
        LatencyResolver.prototype.UpdateLatency = function () {
            var validItemCount = 0, totalValue = 0, standardDeviation = Warspace.StandardDeviation(this._pingData), baseAverage = Warspace.Average(this._pingData);
    ...
    Warspace.LatencyResolver = LatencyResolver;
})(Warspace || (Warspace = {}));
