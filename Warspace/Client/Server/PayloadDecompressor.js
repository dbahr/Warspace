    ...
    (function (Server) {
        var PayloadDecompressor = (function () {
            ...
            PayloadDecompressor.prototype.DecompressShip = function (ship) {
                ...
                result.MovementController.Position = result.MovementController.Position.Add(Warspace.Ship.SIZE.Multiply(.5));
                ...
                result.Style = ship[this.ShipContract.Style];
            ...
            PayloadDecompressor.prototype.DecompressPowerup = function (data) {
                return {
                    MovementController: {
                        Position: new eg.Vector2d(data[this.PowerupContract.PositionX] + Warspace.HealthPack.SIZE.HalfWidth, data[this.PowerupContract.PositionY] + Warspace.HealthPack.SIZE.HalfHeight),
                        Rotation: 0
                    },
